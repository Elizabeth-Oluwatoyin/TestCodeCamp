...
public class KongaTest2 {
    ...
    public void SignIn() throws InterruptedException {
        ...
        driver.findElement(By.id("username")).sendKeys("lizzyadeyeni12@gmail.com");
        //7. Enter password
        driver.findElement(By.id("password")).sendKeys("123ade");
        Thread.sleep(3000);
        //8. Click Login
